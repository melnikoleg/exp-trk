...
vi.mock('../../pages/VerificationCode', () => ({ default: () => <div>VerificationCode Page</div> }));
vi.mock('../../pages/RestorePassword', () => ({ default: () => <div>RestorePassword Page</div> }));
vi.mock('../../pages/Success', () => ({ default: () => <div>Success Page</div> }));

vi.mock('../AuthLayout', () => ({ default: ({ children }: { children: React.ReactNode }) => <div>Auth Layout: {children}</div> }));

vi.mock('../../routes/PrivateRoute', () => ({
  default: ({ children }: { children: React.ReactNode }) => <div data-testid="private-route">Private Route: {children}</div>
}));
...
describe('App Component', () => {
  ...
  it('shows loading state initially', async () => {
    ...
    authModule.initAuth = vi.fn().mockImplementation(
